            ...
            <div class="u-layout-row">
              <div class="u-align-center u-container-style u-layout-cell u-left-cell u-size-23 u-layout-cell-1">
                <div class="u-container-layout u-valign-middle u-container-layout-1">
                  <div alt="" class="u-image u-image-circle u-image-1" style="background-image: url('data:image/jpg;base64,${client.image}')" src="" data-image-width="256" data-image-height="256"></div>
                  <a href="changeImage.do" class="u-btn u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-btn-1">Change profile picture</a>
                </div>
              </div>
              <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-37 u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  <h2 class="u-text u-text-1">${client.firstName} ${client.lastName}</h2>
                  <h6 class="u-text u-text-2">Username: ${client.userName}</h6>
                  <h6 class="u-text u-text-3">Position: ${client.position}</h6>
                  <h6 class="u-text u-text-4">Date of birth: ${client.dateOfBirth}</h6>
                  <h6 class="u-text u-text-5">Mail Code: ${client.mailCode}</h6>
                  <h6 class="u-text u-text-6">Phone Number: ${client.phoneNumber}</h6>
                  <a href="changePassword.do" class="u-active-none u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-hover-none u-none u-btn-2">Change password</a>
                </div>
              </div>
            </div>
          </div>
            	...
            	<c:forEach var="subscription" items="${subscriptions}">
					<tr style="height: 77px;">
		                ...
		                <c:if test="${subscription.status == 'Not Received'}">
		                	<td class="u-border-1 u-border-grey-30 u-table-cell"><a href="receive.do?periodicalName=${subscription.periodicalName}">${subscription.status}</a></td>
		                ...
		                <c:if test="${subscription.status == 'Received'}">
		                	...
		                	<td class="u-border-1 u-border-grey-30 u-table-cell"><a href="sent.do?periodicalName=${subscription.periodicalName}" id="notsenta" onclick="toggle()">Not Sent</a></td>
		                </c:if>
